...
public class CadastroView extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        UsuarioDTO dadosNovoCadatro = new UsuarioDTO();
        dadosNovoCadatro.setNome(txtNome.getText());
        dadosNovoCadatro.setEmail(txtEmail.getText());
        dadosNovoCadatro.setSenha(txtSenha.getText());
        dadosNovoCadatro.setTelefone(txtTelefone.getText());
        dadosNovoCadatro.setcPF(txtCPF.getText());
       if( ValidacaoCpf.validarCPF(dadosNovoCadatro.getcPF())&& ValidacaoEmail.validar(dadosNovoCadatro.getEmail())){
        CrudCadastroDAO cad = new CrudCadastroDAO();

        cad.cadastrarNovoUsuario(dadosNovoCadatro);
